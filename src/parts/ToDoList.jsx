...
import { List, ListItem, ListItemText, Checkbox, TextField, Button, Paper, IconButton, Typography, Box } from '@mui/material';
...
function ToDoList() {
  ...
  return (
    <>
      <StyledPaper>
  <Typography color={"white"} variant="h6">To Do's</Typography>
  <Box display="flex" flexDirection="column" height="90%">
      ...
      <List >
        {todos.map((todo, index) => (
          ...
          >
            ...
            <ListItemText primaryTypographyProps={{ style: { color: 'white' } }}primary={todo.text} color={"white"} />
            {hoverIndex === index && (
    ...
    <WhiteTextField
              ...
              label="New To-Do"
            />
      <Button onClick={addTodo} variant="contained" color="secondary" style={{marginTop: 5, marginLeft: 3, height:45}}>Add</Button>
    </Box>
  </Box>
</StyledPaper>
